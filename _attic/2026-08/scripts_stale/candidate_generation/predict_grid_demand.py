...
with open(BASE + "models/model2_xgboost_2029_v3.pkl", "rb") as f:
    model_2029 = pickle.load(f)
with open(BASE + "models/model2_xgboost_2031_v3.pkl", "rb") as f:
    model_2031 = pickle.load(f)

grid = gpd.read_file(BASE + "data/processed/candidate_grid_final_v5.geojson")
...
prophet = pd.read_csv(BASE + "data/processed/gu_cohort_change_prophet.csv")
...
# 저장
geojson_out = BASE + "data/processed/candidate_grid_xgb_v4.geojson"
csv_out = BASE + "data/processed/candidate_grid_xgb_v4.csv"
