...
grid = gpd.read_file(BASE + "data_processed/candidate_grid_final_v5.geojson")
...
# 저장
geojson_out = BASE + "data_processed/candidate_grid_xgb_v4.geojson"
csv_out = BASE + "data_processed/candidate_grid_xgb_v4.csv"
