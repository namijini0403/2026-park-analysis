  ...
  return (
    <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-5">
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl bg-white/80 px-4 py-3">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">표시 녹지 비율</p>
    ...
    <div className="mx-auto flex max-w-[1380px] flex-col gap-8 px-4 py-8 lg:px-8">
      <section className="space-y-5 rounded-[32px] border border-slate-200 bg-white p-7 shadow-sm">
        <div className="space-y-2">
          ...
          <h1 className="text-4xl font-black tracking-tight text-slate-950 lg:text-5xl">{CITY_NAME} 학교 전체 통계 리포트</h1>
