...
도보 네트워크·보행 부담·활동규모 기준을 반영한 초등학교 야외활동 환경 진단 및 XAI 우선지원 의사결정 시스템
...
본 분석은 공식 공원 존재 여부를 부정하지 않고, 초등학생 야외활동 환경 관점에서 공식 공원 접근성과 활동규모 공원 접근성을 분리해 진단한다.

여기서 활동규모 공원은 본 프로젝트의 분석상 운영 기준인 **3,000㎡ 이상** 공원이다. 기준 면적 이상으로 아이들이 머물며 활동할 수 있는 규모의 공원으로 해석하며, 공식 공원 전체와 구분해 표시한다.
...
| 활동규모 기준 | 도달한 공간이 아이들이 머물며 활동할 만한 기준 면적을 갖추었는가 | 면적 기반 `park_function_class` 보조 레이어로 해석한다 |
...
## 공식 공원 접근성과 활동규모 공원 접근성 분리 기준

본 프로젝트는 공식 공원 여부를 부정하지 않는다. 다만 초등학생 야외활동 환경을 진단할 때, 공식 공원 “존재”와 아이들이 머물며 활동할 수 있는 “활동규모 기준”은 분리해 해석한다.
...
| mid_activity_park | 3,000㎡ 이상 ~ 10,000㎡ 미만 | 분석상 운영 기준 | 활동규모 공원 | 기준 면적 이상으로 아이들이 머물며 활동할 수 있는 규모 |
| neighborhood_park_scale | 10,000㎡ 이상 | 근린생활권 근린공원 규모 기준 이상 | 근린공원급 활동규모 공원 | 넓은 활동규모 공원으로 해석 |
