...
| 도보권 녹지율(%) | 8.32 | 2.10 | 0.43 | 6.82 | 0.00 | 95.92 |
...
| case 2 | 68 | 27 | 61 | 0.31% | 0.25% | 248.7m |
| case 3 | 77 | 0 | 69 | 2.52% | 2.36% | 211.5m |
| case 4 | 80 | 0 | 67 | 22.48% | 12.73% | 201.0m |
...
3. **case2는 "가까운 공원이 아예 없음"만의 문제가 아니다.**
   최근접 공원이 500m 안에 있어도 도보권 녹지율이 1% 미만이면 우선 검토 대상이다.
