...
> 정책대안은 학교 내부 직접투자, 외부 신규 공급, 기관 연계, 이동형·순회 서비스, 접근경로·안전환경 개선, 권역 공동활용·거점화, 유지·모니터링의 7가지 공통 정책 행동 유형으로 추상화되며, 각 모듈이 자원별 대안으로 구체화한다.
...
**수요 근거:**
- 2029년 예측수요 X명 (상위 25% 기준: 550명 이상)
...
| 1.0 (12/12 조합 안정) | 131 | mobile_service(83), institution_link(3), maintain_monitor(45) + separate_track(30) |
