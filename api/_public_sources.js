...
const files={
 ...
 'data_processed/education/boundary_comparison.json':[ZONES,OSM],
 'data_processed/context/school_context_summary.json':[DESIGNATIONS,NIGHTLIFE[0],CONSTRUCTION[0]],
 'data_processed/education/academy_school_context.json':[ACADEMY],
 'data_processed/school_similar_schools_top5.csv':[SCHOOLINFO,APT,REDEV[0]],
 'data_processed/education/shared_parks.json':[PARKS,SCHOOLINFO],
