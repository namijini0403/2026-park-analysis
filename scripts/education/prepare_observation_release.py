...
Deploy this allowlisted package with railway up --no-gitignore: ancestor Git
ignore rules otherwise omit vercel_public and break the data symlink.
"""
...
for name in ['school-zones.js','office-documents.js','data-refresh.js','student-services.html','student-services.js']:
...
shutil.copytree(ROOT/'data_processed/student_services',public/'data_processed/student_services',dirs_exist_ok=True)
for name in ['policy_action_cards.json','school_library_access.csv']:
    shutil.copy2(ROOT/'data_processed'/name,public/'data_processed'/name)
out=ROOT/'outputs/observations-first-20260912'
