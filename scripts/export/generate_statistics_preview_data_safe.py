...
PRIORITY_PATH = BASE / "data/processed" / "school_priority.csv"
FORECAST_PATH = BASE / "data/processed" / "school_enrollment_forecast_20260418_model1.csv"
STUDENT_TREND_PATH = BASE / "data/processed" / "student_trend.csv"
...
def main() -> None:
    ...
    data = {
        ...
        "cityBestSchool": school_record(city_best_row, 1) if city_best_row is not None else build_empty_best_school(CITY_NAME),
    }
