...
| `analysis_nearest_park.py`, `recalc_nearest_park_public_only.py`, `update_manual_verified_nearest_parks.py` | `pipeline/layers/park/accessibility.py` (예정) | ⚠️봉인 관련 — 재실행 금지, 아래 `layers/park/README.md` 경고 참고 |
