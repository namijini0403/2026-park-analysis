...
| `analysis_school_priority.py`, `apply_case_system_20260411.py` (→ `_attic/2026-08/oneoff_fixes/apply_case_system_20260411.py`로 보관됨), `rebuild_priority_with_redev.py` | `pipeline/layers/park/priority.py` (예정) | ⚠️봉인 관련 |
