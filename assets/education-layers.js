...
window.EducationLayers = (() => {
  ...
  let allSchools = [], disclosures = {}, labels = {}, routes = null, regionalDemography = {}, regionalForecasts = {}, regionalForecastValidation = {}, publicIndicators = {}, scienceAwards = {}, candidateAgeDemand = {}, academies = [], candidateGrid = null, reportRequest = 0;
  ...
  async function openReport(row) {
    ...
    try {
      ...
      if (!routes) [labels, routes, regionalDemography, scienceAwards, candidateAgeDemand, regionalForecasts, regionalForecastValidation, publicIndicators] = await Promise.all([json('disclosure_labels.json'),json('school_routes.json'),json('regional_demography.json'),json('science_awards.json'),json('candidate_age_demand.json'),json('regional_age_forecasts.json'),json('regional_age_forecast_validation.json'),json('school_public_indicators.json')]);
