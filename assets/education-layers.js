...
window.EducationLayers = (() => {
  ...
  function openStatistics() {
    ...
    const networks=document.createElement('section');networks.id='educationNetworks';body.appendChild(networks);
    if(window.EducationNetworks) window.EducationNetworks.mount(networks,document.getElementById('schoolLevelFilter')?.value,state.selectedGu);
